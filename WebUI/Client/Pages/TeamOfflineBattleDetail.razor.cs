...
public partial class TeamOfflineBattleDetail
{
    [Parameter]
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        breadcrumbs.Add(new BreadcrumbItem(localizer["cardviewdetail"], href: $"/Cards/TeamOfflineBattleDetail/{ChipId}", disabled: false));

        AccessCode = await _jsRuntime.InvokeAsync<string>("accessCode.get");

        var constructor = new OfflineBattlePageContextConstructor(Http, DataService, AccessCode, ChipId, "Team");
