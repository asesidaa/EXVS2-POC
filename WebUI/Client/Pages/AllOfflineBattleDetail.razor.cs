...
public partial class AllOfflineBattleDetail
{
    [Parameter]
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        breadcrumbs.Add(new BreadcrumbItem(localizer["cardviewdetail"], href: $"/Cards/AllOfflineBattleDetail/{ChipId}", disabled: false));

        AccessCode = await _jsRuntime.InvokeAsync<string>("accessCode.get");

        var constructor = new OfflineBattlePageContextConstructor(Http, DataService, AccessCode, ChipId, "All");
