...
{
    auto client_type_offset_1 = VS2_XB_OB(0x14066DF3C, 0x1406BC45C, 0x1406DEE9C) - base_address;
    injector::MakeNOP(exe_base_pointer + client_type_offset_1, 6, true);
    
    auto client_type_offset_2 = VS2_XB_OB(0x14066DF47, 0x1406BC467, 0x1406DEEA7) - base_address;
