...
{
    /// <inheritdoc />
    public partial class UploadReplay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_upload_replay", x => x.ReplayId);
                    table.ForeignKey(
                        name: "FK_upload_replay_card_profile_CardId",
                        column: x => x.CardId,
